...
internal static class CameraFollowClinicalChecks
{
    ...
    private static void CheckSettingsMigration()
    {
        ...
        try
        {
            ...
            // Pinned to the highest migration step (v13, the non-custom water-detail
            // rebaseline). The point of loading a v9 file is to prove the v10 camera seeding
            // still survives the whole chain, so a new step should force that to be
            // re-confirmed rather than pass by >=.
